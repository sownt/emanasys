...
import com.vosxvo.java.controllers.EmployeesController;
...
public class EmployeeThread extends Thread {
    ...
    public EmployeeThread(EmployeesController controller, int offset) {
    ...
    public void run() {
        ...
        try {
            ...
            ResultSet sets = statement.executeQuery(String.format("SELECT `emp_no`, `first_name`, `last_name`, `birthday`, `gender`, `hire_date` FROM `employees` LIMIT %d OFFSET %d;", 25, offset));
